...
@section('content')
    <div class="container mx-auto max-w-2xl">
        ...
        <div class="bg-white p-6 rounded-md shadow-md">
            ...
            @else
                <form action="{{ route('competitions.schedules.bulk-create', $competition) }}" method="POST"
                    id="bulk-schedule-form" class="contents">
                    @csrf
                    ...
                    <div class="my-5">
                        ...
                        <select name="group_select" id="group-select" class="select select-bordered w-full mt-2" required>
                    ...
                    <div class="my-5">
                        ...
                        <input type="time" name="start_time" id="start_time"
                            value="{{ $lastSchedule?->end_at?->format('H:i') ?? '08:30' }}"
                            class="input input-bordered block mt-2 w-full" required>
                    </div>
                    ...
                    <div class="my-5">
                        ...
                        <input type="text" name="venue" id="venue" placeholder="例如：田径场"
                    ...
                    <div class="inline mt-6">
                        ...
                        @if (request()->query('type') === 'track')
                            <a href="{{ route('competitions.schedules.index', $competition) }}" class="btn">取消</a>
                        @else
                            <a href="{{ route('competitions.schedules.index-field', $competition) }}"
                                class="btn">取消</a>
                        @endif
                    </div>
                </form>
                ...
                <script>
                    function initBulkScheduleForm() {
                        ...
                        function updateTimePreview(heatsCount, avgTime) {
                            ...
                            document.getElementById('preview-start').textContent = startDateTime.toLocaleTimeString('zh-CN', {
                                hour: '2-digit',
                                minute: '2-digit'
                            });
                            document.getElementById('preview-end').textContent = endDateTime.toLocaleTimeString('zh-CN', {
                                hour: '2-digit',
                                minute: '2-digit'
                            });
