...
class CompleteDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $trackEvents = [
            ...
            ['name' => "1000米", 'gender' => "男", 'event_type' => "track", 'avg_time' => 10, 'max_participants' => 6],
            ...
            ['name' => "4*100米接力", 'gender' => "男", 'event_type' => "track", 'avg_time' => 20, 'max_participants' => 24],
            ['name' => "4*100米接力", 'gender' => "女", 'event_type' => "track", 'avg_time' => 20, 'max_participants' => 24],
        ];
        ...
        $fieldEvents = [
            ...
            ['name' => "实心球", 'gender' => "男", 'event_type' => "field", 'avg_time' => 30, 'max_participants' => 99],
            ['name' => "实心球", 'gender' => "女", 'event_type' => "field", 'avg_time' => 30, 'max_participants' => 99],
        ];
